import type { DecoratorContext, DecoratorValidatorCallbacks, FunctionContext, Model, ModelProperty, Type } from "@typespec/compiler";
...
export type ApplyMergePatchTransformFunctionImplementation = (context: FunctionContext, input: Model, nameTemplate: string, options: ApplyMergePatchOptions) => Model;
